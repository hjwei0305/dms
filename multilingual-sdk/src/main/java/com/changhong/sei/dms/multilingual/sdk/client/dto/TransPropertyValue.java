...
public class TransPropertyValue implements Serializable {
    private static final long serialVersionUID = 3118672946360076597L;
    /**
     * 属性名
     */
    @NotBlank
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TransPropertyValue)) return false;
        TransPropertyValue value = (TransPropertyValue) o;
        return Objects.equals(getPropertyName(), value.getPropertyName()) &&
                Objects.equals(getPropertyValue(), value.getPropertyValue());
    }
